...
namespace KutuphaneProjesi
{
    public partial class FormKitaplar : Form
    {
        ...
        private void buttonKitapEkle_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Kitap Eklenirken Bir hata Olustu" + ex.Message);
            }
            finally
            {
                baglanti.Close();
        ...
        private void buttonKitabıOduncVer_Click(object sender, EventArgs e)
        {
            if (labelID.Text != "-")
            {
                try
                ...
                {
                    MessageBox.Show("Kitap Odunc Islemi Sırasında Bir hata Olustu" + ex.Message);
                }
                finally
                {
                    baglanti.Close();
            ...
            {
                MessageBox.Show("Lutfen Listeden Bir Kitap Seciniz");
            }
        }
